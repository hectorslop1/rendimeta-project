...
export function Topbar() {
  ...
  return (
    <header className="flex h-16 shrink-0 items-center justify-between border-b border-gray-100 bg-white/80 backdrop-blur-sm text-[color:var(--app-topbar-text)] px-4 lg:px-6 shadow-sm">
      {/* Breadcrumbs - offset for mobile menu button */}
      <nav
        className="flex items-center gap-1.5 pl-10 lg:pl-0"
